...
-- CreateIndex
CREATE INDEX "Notification_assignedById_idx" ON "Notification"("assignedById");
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_assignedById_fkey" FOREIGN KEY ("assignedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
